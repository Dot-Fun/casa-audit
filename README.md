...
A [Claude Code](https://docs.anthropic.com/en/docs/claude-code) skill that performs a **CASA (Cloud Application Security Assessment)** security audit on any codebase. Evaluates all 73 CASA-required OWASP ASVS 4.0.3 controls using a team of 7 specialist agents working in parallel.
...
- **Spawns 7 specialist agents** that audit in parallel across all ASVS chapters
...
- **Static analysis only** — no DAST, pen testing, or fuzzing
